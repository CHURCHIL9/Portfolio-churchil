  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
      <div className="flex flex-col gap-1  justify-center">
        <FaTableTennis size={28} className="text-[#172e2c]" />
        <p className="font-semibold text-gray-400">Sports</p>
      </div>
      <div className="flex flex-col gap-1  justify-center">
        <FaMusic size={28} className="text-[#172e2c]" />
        <p className="font-semibold text-gray-400">Music</p>
      </div>
      <div className="flex flex-col gap-1  justify-center">
        <GiPalmTree size={28} className="text-[#172e2c]" />
        <p className="font-semibold text-gray-400">Travel</p>
      </div>
      <div className="flex flex-col gap-1  justify-center">
        <FaBookOpenReader size={28} className="text-[#172e2c]" />
        <p className="font-semibold text-gray-400">Learn</p>
      </div>
      <div className="flex flex-col gap-1  justify-center">
        <FaCoffee size={28} className="text-[#172e2c]" />
        <p className="font-semibold text-gray-400">Reading</p>
      </div>
      <div className="flex flex-col gap-1  justify-center">
        <FaRunning size={28} className="text-[#172e2c]" />
